...
<div id="bloque1" class="z-depth-3">
    <div class="row">
        <div class="col s9" id="infoAl">
            @foreach ($admn as $datos)
                <h5 class="center-align white-text condensed light">Bienvenido, {{$datos->Nombre}} {{$datos->ApellidoP}} {{$datos->ApellidoM}}</h5>
                <br><h5 class="center-align white-text thin">{{$datos->idadministrador}}</h5>
